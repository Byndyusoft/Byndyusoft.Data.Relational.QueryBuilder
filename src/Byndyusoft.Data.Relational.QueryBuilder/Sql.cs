...
namespace Byndyusoft.Data.Relational.QueryBuilder
{
    public static class Sql
    {
        ...
        public static string Select<T1, T2>(Expression<Func<T1, T2, string>> expression, string? alias1 = null, string? alias2 = null)
        {
        ...
        public static string Select<T1, T2, T3, T4>(Expression<Func<T1, T2, T3, T4, string>> expression, string? alias1 = null,
