# Contributing to Byndyusoft.Data.Relational.QueryBuilder
...
If you want to fix, to add enhancement, or to improve documentation, you need to learn how to work with GitHub, Byndyusoft.Data.Relational.QueryBuilder code base and contributing rules.
...
```shell
 git clone https://github.com/Byndyusoft/Byndyusoft.Data.Relational.QueryBuilder.git
```
